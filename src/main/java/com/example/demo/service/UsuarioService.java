...
public class UsuarioService {
    ...
    // TODO: DESENVOLVER LÓGICA COM SPRING MAIL SENDER!
    public void recuperarSenha(Usuario usuario) {
        Optional<Usuario> emailOptional = usuarioRepository.findByEmail(usuario.getEmail());
        if (emailOptional.isPresent()) {
            dispararEmailDeRecuperacao(usuario);
        }
    }

    // TODO: DESENVOLVER LÓGICA COM SPRING MAIL SENDER!
    public void dispararEmailDeRecuperacao(Usuario usuario) {
        System.out.println("Email disparado");
